...
struct FFireWeaponData : public FTableRowBase
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Projectile")
	...
	UPROPERTY(BlueprintReadOnly, EditDefaultsOnly, Category = "FireWeapon|Behavior|Projectile")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Fire", DisplayName = "Delay Between Bullets (Burst mode Only)")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Damage")
	FVector2D DamageRange = {20.f, 40.f};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Damage")
	FVector2D HeadShotDamageRange = {1.f, 1.f};

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Aiming")
	bool bShouldAds{false};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Aiming")
	float AimFOV{80.f};
	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Recoil", DisplayName = "Recoil Pitch Curve")
	UCurveFloat* RecoilPitchCurve{nullptr};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Recoil", DisplayName = "Recoil Yaw Curve")
	UCurveFloat* RecoilYawCurve{nullptr};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Recoil", DisplayName = "Recoil Velocity")
	float RecoilVelocity{0.04f};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior|Recoil", DisplayName = "Time to Reset Recoil")
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "FireWeapon|Behavior")
